...
<html lang="es">
	<head>
	    ...
	    <title>tienda de Regalos - Pagina principal</title>
		...
		<div class="row">
			...
			<div class="hidden-md col-sm-4 col-lg-4">
				<div class="info-box">
					...
					<h6 class="text">envio gratis en pedidos mayores a S/.600.00</h6>	
				</div>
			</div><!-- .col -->
			...
			<div class="more-info-tab clearfix">
			   <h3 class="new-product-title pull-left">Productos Destacados</h3>
				<ul class="nav nav-tabs nav-tab-line pull-right" id="new-products-1">
					...
					<li><a href="#books" data-toggle="tab">Cumpleaños</a></li>
					<li><a href="#furniture" data-toggle="tab">Aniversarios</a></li>
				</ul><!-- /.nav-tabs -->
			</div>
	...
	<div class="product">		
		<div class="product-image">
			<div class="image">
				...
				<img  src="admin/productimages/<?php echo htmlentities($row['id']);?>/<?php echo htmlentities($row['productImage1']);?>" data-echo="admin/productimages/<?php echo htmlentities($row['id']);?>/<?php echo htmlentities($row['productImage1']);?>"  width="200" height="250" alt=""></a>
			</div><!-- /.image -->			
		...
		<div class="product-info text-left">
			...
			<div class="product-price">	
				<span class="price">
				S/.<?php echo htmlentities($row['productPrice']);?>			</span>
										     <span class="price-before-discount">S/.<?php echo htmlentities($row['productPriceBeforeDiscount']);?>	</span>
				...
				<div class="row">
					<div class="col-md-6">
	                   <section class="section">
	                   	<h3 class="section-title">Amor y Amistad</h3>
...
<?php }?>
					...
					<div class="col-md-6">
						<section class="section">
							<h3 class="section-title">Infantil</h3>
		                   	<div class="owl-carousel homepage-owl-carousel custom-carousel outer-top-xs owl-theme" data-item="2">
	<?php
...
<?php }?>
	...
	<section class="section featured-product inner-xs wow fadeInUp">
		<h3 class="section-title">Aniversarios</h3>
								...
								<div class="row product-micro-row">
									...
									<div class="col col-xs-6">
										<div class="product-info">
											...
											<div class="product-price">	
												<span class="price">
													S/. <?php echo htmlentities($row['productPrice']);?>
												</span>
