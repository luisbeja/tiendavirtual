...
<div class="stock-container info-container m-t-10">
							...
							<div class="price-container info-container m-t-20">
								<div class="row">
									...
									<div class="col-sm-6">
										<div class="price-box">
											<span class="price">S/. <?php echo htmlentities($row['productPrice']);?></span>
											<span class="price-strike">S/.<?php echo htmlentities($row['productPriceBeforeDiscount']);?></span>
										</div>
									</div>
	...
	<div class="product">		
		...
		<div class="product-info text-left">
			...
			<div class="product-price">	
				<span class="price">
					S/.<?php echo htmlentities($rw['productPrice']);?>			</span>
										     <span class="price-before-discount">S/.
